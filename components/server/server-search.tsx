  ...
  return (
    <>
      <button 
        ...
        <p
          className="font-semibold text-sm text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-600 dark:hover:bg-zinc-600 dark:group-hover:text-zinc-300 transition"
        >Search</p>
        <kbd 
